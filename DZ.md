...
Тут конфликт  
а здесь его нет  
Почему-то при создании конфликта возникла проблема, vs code не визуализировал изменения как было показано в лекциях и на практике, говорил, что есть ошибка, но не показывал где, лишь в каком файле, так и не понял почему. Так было когда была лишь одна строка "делаем конфликт" в мейне и "Тут конфликт" в ветке. Когда добавил в ветку строку "а здесь его нет" и по новой сделал конфликт, всё получилось как в лекциях и на практике. Если возможно, сообщите как-нибудь почему так произошло.